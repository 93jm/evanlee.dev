...
import * as css from "@/features/blog/styles/blog.css";
...
function ContentImage({
  ...
  const imageSource = resolveMdxImageSource(postSlug, src);
...
function resolveMdxImageSource(postSlug: string, src: unknown): string {
  ...
  return getContentAssetPublicUrl("blog", postSlug, src);
}

export function createBlogMdxComponents(postSlug: string): MDXRemoteProps["components"] {
  return {
    ...
    img: (props) => <ContentImage postSlug={postSlug} {...props} />,
    Callout,
  };
}
