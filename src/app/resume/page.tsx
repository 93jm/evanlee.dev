    ...
    <div className={css.resumeSectionWrapper} style={{ paddingTop: 20 }}>
      <section>
        ...
        <p className={css.resumeTextBox} style={{ fontSize: 14 }}>
          ...
          역량을 늘리는 시간을 굉장히 값지게 생각하고 있어요. 그러한 이유는,
          결국 서비스는 혼자 만드는 것이 아니라 같이 고민하고 만드는 것이므로,
          내가 늘린 나의 역량이 다른 동료들에게 도움이 되어 같이 성장하는 것이
          곧 내 성장이되고 그러한 긍정적인 영향을 가진 팀이 모여 만든 서비스는
